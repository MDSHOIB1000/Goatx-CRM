                            ...
                            <div className="sm:col-span-12">
                                ...
                                <div className="mt-2">
                                    <input
                                        ...
                                        className="block w-full rounded-md bg-transparent px-3 border-2 border-white py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                    />
                                </div>
                            </div>
                        </div>
