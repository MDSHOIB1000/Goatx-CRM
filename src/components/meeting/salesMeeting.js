  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-slate-950 my-2 p-1">
        <h1 className="text-white font-bold text-xl">Meetings</h1>
      </div>
        <div className="flex justify-between items-center mb-4">
          <Link to="/sale/addmeeting  " className="bg-blue-500 text-white px-4 py-2 rounded">+ Add New Meeting</Link>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border border-gray-300">
            <thead className="bg-blue-950 text-white">
              <tr>
                {[
                  "Remark", "Company", "Company Contact", "Assign To", "Due Date", "Status",
