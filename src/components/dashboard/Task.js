    ...
    <div className="mt-4 mx-2">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          <div className="p-2">
            <div className="mb-3 px-3 py-2 border rounded flex justify-between items-center bg-gray-50">
              <div>
            ...
            <div className="mb-3 px-3 py-2 border rounded flex justify-between items-center">
              <div>
            ...
            <div className="px-3 py-2 border rounded flex justify-between items-center">
              <div>
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          <div className="p-4">
            ...
            <div className="px-3 py-2 border rounded flex justify-between items-center bg-gray-50">
              <div>
